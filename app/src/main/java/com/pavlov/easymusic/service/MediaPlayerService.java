...
public class MediaPlayerService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    public static final String ACTION_PLAY = "easy_player.ACTION_PLAY";
    public static final String ACTION_PAUSE = "easy_player.ACTION_PAUSE";
    public static final String ACTION_PREVIOUS = "easy_player.ACTION_PREVIOUS";
    public static final String ACTION_NEXT = "easy_player.ACTION_NEXT";
    public static final String ACTION_STOP = "easy_player.ACTION_STOP";
    ...
    public void buildNotification(PlaybackStatus playbackStatus) {
        ...
        if (playbackStatus == PlaybackStatus.PLAYING) {
            notificationAction = R.drawable.ic_pause_main;
            //create the pause action
            play_pauseAction = playbackAction(1);
        } else if (playbackStatus == PlaybackStatus.PAUSED) {
            notificationAction = R.drawable.ic_play_arrow_main;
    ...
    private BroadcastReceiver playNewAudio = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            audioIndex = new StorageUtil(getApplicationContext()).loadSongIndex();
            if (audioIndex != -1 && audioIndex < audioList.size()) {
                //index is in a valid range
                activeAudio = audioList.get(audioIndex);
            } else {
